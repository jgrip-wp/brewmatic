...
<body>
  <div id="wrapper">
    ...
    <article>
      <div id="contents">
        <p id="breadcrumb" class="op"><a href="./" class="home fonten">Top</a> > ブルーマチックジャパンについて</p>
        <div class="contents_main">
          <div class="inner">
            ...
            <div class="aboutus_section">
              <div class="aboutus_place wow fadeIn">
                ...
                <div class="aboutus_place_cont">
                  <h3 class="aboutus_place_tit">コーヒー文化のフロンティアとして、<br>あらゆる場所と時間に<br>コーヒーマシンのある社会をつくる</h3>
                  <ul class="aboutus_place_txt">
                    <li>ブルーマチックジャパンはコーヒーの輸入が全面自由化された1960年代、商社の1事業としてスタート、1984年にコーヒーマシンの専門商社として横浜で創業しました。<br>当社のオリジンは1920年代のアメリカに遡ります。当時、ロスアンゼルスで創業したコーヒー豆などを扱う大手食品会社、ファーマーブラザーズのコーヒーマシン部門が1937年に独立し、世界のコーヒーマシン市場を牽引したのが、ブルーマチックインターナショナル社（当時ウエスタンアーン社）であり、日本市場の開拓を担ったのが、ブルーマチックジャパンです。そして、2014年には、ファーマーブラザーズよりブルーマチックブランドの商標を譲り受け、歴史や誇りとともに、コーヒー文化普及への意志を受け継ぐことになりました。<br>以来、一貫して「本格的なコーヒーの味を追求し、優れたコーヒーマシンを提供して、人々のゆとりある生活に貢献する」という経営理念のもと日々事業に取り組んでいます。</li>
            ...
            <!-- /aboutus_section -->
            <div class="aboutus_section">
              <h3 class="page_title_mid wow fadeIn"><span class="page_title_en fonten">Company</span>会社概要</h3>
              <div class="aboutus_company">
                <div class="aboutus_company_box wow fadeIn">
                  <table class="common_table">
                    <tr>
                      <th>社名</th>
                      <td>ブルーマチックジャパン株式会社<br>Brewmatic Japan Ltd.</td>
                    </tr>
                    <tr>
                      <th>住所</th>
                    ...
                    <tr>
                      <th>従業員</th>
                      <td>124名<br>(2020年3月末現在)</td>
                    </tr>
                    <tr>
                      <th>取引<br>銀行</th>
                      <td>みずほ銀行 横浜支店<br>三井住友銀行 横浜駅前支店<br>横浜銀行 新横浜支店</td>
                    </tr>
                  </table>
                </div>
                <div class="aboutus_company_box wow fadeIn">
                  <table class="common_table">
                    <tr>
                      <th>営業所</th>
                      <td>
                        <div class="aboutus_company_addr">
                          <p>大阪営業所<br>〒550-0011<br>大阪府大阪市西区阿波座1-9-9 阿波座パークビル5階<br>TEL：06-6531-1336（代表）　FAX：06-6537-5131</p>
                          <p class="aboutus_company_map fonten"><a href="https://goo.gl/maps/82XzRibiPk5tEF5Z8" target="_blank">Google Map</a></p>
                        </div>
                        <div class="aboutus_company_addr">
                          <p>福岡営業所<br>〒812-0042<br>福岡県福岡市博多区豊1-5-24 丸信ビル108<br>TEL：092-483-3245（代表）　FAX：092-483-3246</p>
                          <p class="aboutus_company_map fonten"><a href="https://goo.gl/maps/dxhHEKv52k2NidDK8" target="_blank">Google Map</a></p>
                        </div>
                      </td>
                    </tr>
                  </table>
            ...
            <!-- /aboutus_section -->
            <div class="aboutus_section aboutus_history" id="history">
              <h3 class="page_title_mid wow fadeIn"><span class="page_title_en fonten">History</span>ブルーマチックジャパンの歩み</h3>
              <div class="aboutus_history_box">
                <div class="aboutus_history_in wow fadeIn">
                  <p class="aboutus_history_date fontamiri">1960s</p>
                  <div class="ftbox">
                    <table>
                      <tr>
                        <td><p class="aboutus_history_hdl">「ブルーマチックプロジェクト」始動</p></td>
                ...
                <!-- /aboutus_history_in -->
                <div class="aboutus_history_in wow fadeIn">
                  <p class="aboutus_history_date fontamiri">1980s</p>
                  <div class="ftbox">
                    <table>
                      <tr>
                        <td><p class="aboutus_history_hdl">ブルーマチックジャパン創業</p></td>
                        <td class="whalf">&nbsp;</td>
                      </tr>
                      <tr>
                        <td><p class="aboutus_history_txt">1984年　ブルーマチックインターナショナル社の協力により商社から独立し、横浜でブルーマチックジャパン株式会社を創業。<br>高度成長期からの勢いと急速な欧米化を背景に、喫茶店、ホテルをはじめ様々な外食産業へ進出。</p></td>
                        <td class="whalf">&nbsp;</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td class="whalf"><p class="aboutus_history_txt">1990年代<br>シアトル系コーヒーの日本進出。</p></td>
                      </tr>
                      <tr>
                        <td><p class="aboutus_history_txt">●●年　大阪営業所設立。</p></td>
                        <td class="whalf">&nbsp;</td>
                      </tr>
                      <tr>
                ...
                <!-- /aboutus_history_in -->
                <div class="aboutus_history_in wow fadeIn">
                  <p class="aboutus_history_date fontamiri">2011</p>
                  <div class="ftbox">
                    <table>
                      <tr>
                        <td><p class="aboutus_history_hdl">新市場「コンビニコーヒー」の先駆けに貢献</p></td>
                        <td class="whalf">&nbsp;</td>
                      </tr>
                      <tr>
                ...
                <!-- /aboutus_history_in -->
                <div class="aboutus_history_in wow fadeIn">
                  <p class="aboutus_history_date fontamiri">~2020</p>
                  <div class="ftbox">
                    <table>
                      <tr>
                        <td><p class="aboutus_history_hdl">世界中に広がるプレミアムブランドのネットワーク</p></td>
                        <td class="whalf">&nbsp;</td>
                      </tr>
                      <tr>
                        <td>
