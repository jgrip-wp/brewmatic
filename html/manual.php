...
<body>
  <div id="wrapper">
    ...
    <article>
      <div id="contents">
        <p id="breadcrumb" class="op"><a href="./" class="home fonten">Top</a> > <a href="./service.php">サポートのご案内</a> > 取扱説明書・承認図のダウンロード</p>
        <div class="contents_main js-showhead">
          <div class="inner">
            ...
            <div class="page_title_detail">
              <p>取扱説明書・承認図のダウンロ―ド</p>
              <p class="service_search_in"><input type="text" id="" name="" class="service_search_input" placeholder="マシン名で検索"><input type="button" id="" name="" value="検索" class="service_search_btn"></p>
            </div>
            <ul class="common_logo">
              <li class="current"><a href="#" class="wow fadeIn"><img src="./images/common/logo01.png" alt=""></a></li>
            ...
            <div class="manual_box">
              <h3 class="manual_box_tit"><img src="./images/common/brewmatic_hd.png" alt=""></h3>
