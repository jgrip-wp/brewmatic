      ...
      <div id="contents">
        ...
        <div class="contents_main js-showhead">
          <div class="inner">
            ...
            <p class="page_title_detail wow fadeIn">製品のメンテナンス方法など、<br class="visiblepc">よくお問い合わせいただく内容を掲載しています。</p>
          </div>
            ...
            <div class="inner">
              ...
              <div class="faq_search_cont">
                ...
                <ul class="faq_step_link op wow fadeIn">
                  <li><a href="#">BREWMATIC、Curtis ドリップマシンの作業手順</a></li>
                  <li><a href="#">CARIMALI 全自動マシンの作業手順</a></li>
                  <li><a href="#">CARIMALI 、SAMNREMO セミオートマシンの作業手順</a></li>
                  <li><a href="#">rheavendors マシンの作業手順</a></li>
                  <li><a href="#">JURA マシンの作業手順</a></li>
                </ul>
              </div>
            </div>
          </div>
