          ...
          <div class="inner">
            <h2 class="page_title wow fadeIn"><span class="page_title_en fonten">Select Machine</span>コーヒーマシンの選び方</h2>
             <ul class="common_bnr wow fadeIn">
               <li><a href="select.php" class="active">条件から選ぶ</a></li>
               <li><a href="consumption.php">消費量から選ぶ</a></li>
               <li><a href="conditions.php">コーディネイトモデル</a></li>
             </ul>
            <!-- /common_bnr -->
            <p class="page_title_detail wow fadeIn">ブランド名、コーヒーの種類など、<br>ご要望の条件にあったマシンを表示します。</p>
            <div class="box_yellow">
              ...
              <!-- /select_box -->
              <div class="select_box">
                <h3 class="select_box_tit wow fadeIn">コーヒーの種類</h3>
                <ul class="select_box_choice wow fadeIn">
                  <li class="current"><a href="#">ドリップコーヒー</a></li>
              ...
              <!-- /select_box -->
              <div class="select_box">
                <h3 class="select_box_tit wow fadeIn">1時間あたりの消費量</h3>
                <ul class="select_box_choice wow fadeIn">
                  <li><a href="#">80杯以内</a></li>
                  <li><a href="#">210杯以内</a></li>
                  <li><a href="#">330杯以内</a></li>
                  <li><a href="#">580杯以内</a></li>
                  <li><a href="#">830杯以内</a></li>
                  <li><a href="#">1000杯</a></li>
                </ul>
              </div>
              <!-- /select_box -->
              <div class="select_box">
                <h3 class="select_box_tit wow fadeIn">提供方法</h3>
                <ul class="select_box_choice wow fadeIn">
                  <li><a href="#">フルサービス</a></li>
                  <li><a href="#">セルフサービス</a></li>
                </ul>
              </div>
              <!-- /select_box -->
            </div>
