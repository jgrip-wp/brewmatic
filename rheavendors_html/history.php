...
<body>
  <div id="wrapper">
    <input type="hidden" id="pageID" value="gNav00">
    <?php include './include/head.php'; ?>
    
    <article>
     <h2 id="teaser" class="teaser_history"><span class="teaser_tit fontlato"> Brand History</span></h2>
      <p id="breadcrumb" class="fontlato op"><a href="./" class="home">Home</a> > <a href="./about.php">About</a> > Brand History</p>
      <div id="contents" class="js-showhead">
       <div class="inner">
         <div class="history_detail wow fadeInUp">
           <p class="flimg"><img src="./images/history/img_history01.jpg" alt="All in the Family"></p>
           <div class="ftbox">
             <h3 class="history_tit fontlato">All in the Family</h3>
             <p class="history_detail_txt">rheavendorsのグループビジョン「All in the Family」。<br>そこには、創業当時から大切にしてきた従業員や地域社会、コーヒーを愛するすべての人々に対する想いが込められています。</p>
           </div>
         </div>
         <!-- /history_detail -->
         ...
         <!-- /history_step -->
         <div class="history_step wow fadeInUp">
           <p class="history_step_img"><img src="images/history/img_history03.jpg" alt="鋳造業からコーヒーマシンのビジネスへ"></p>
           <div class="history_step_cont">
             <div class="history_step_tit">
         ...
         <!-- /history_step -->
         <div class="history_step wow fadeInUp">
           <p class="history_step_img"><img src="images/history/img_history04.jpg" alt="様々なペンディングマシンを展開"></p>
           <div class="history_step_cont">
             <div class="history_step_tit">
         ...
         <!-- /history_step -->
         <div class="history_step wow fadeInUp">
           <p class="history_step_img"><img src="images/history/img_history05.jpg" alt="豆から淹れるペンディングマシンのトップランナーに"></p>
           <div class="history_step_cont">
             <div class="history_step_tit">
         ...
         <!-- /history_step -->
         <div class="history_step wow fadeInUp">
           <p class="history_step_img"><img src="images/history/img_history06.jpg" alt="海外進出の本格化"></p>
           <div class="history_step_cont">
             <div class="history_step_tit">
               <p class="history_step_date"><span class="fontlato">1980-90</span>年代</p>
               <p class="history_step_tit_txt">海外進出の本格化</p>
             </div>
             <p class="history_step_txt">コーヒーの品質を高めると同時に、国や地域の好みに合わせてカスタマイズしたモデルを発表。<br>対応するドリンクメニューのラインナップも増加。<br>世界中でrhavendorsのマシンが高く評価されていく。</p>
           </div>
         </div>
         <!-- /history_step -->
         <div class="history_step wow fadeInUp">
           <p class="history_step_img"><img src="images/history/img_history07.jpg" alt="ハイエンドクラス「la Rhea」を発表"></p>
           <div class="history_step_cont">
             <div class="history_step_tit">
               <p class="history_step_date"><span class="fontlato">2010</span>年代</p>
         ...
         <!-- /history_step -->
         <div class="history_step wow fadeInUp">
           <p class="history_step_img history_step_none">&nbsp;</p>
           <div class="history_step_cont">
             <div class="history_step_tit">
