    ...
    <article>
      <div id="contents">
       ...
       <div class="top_aboutus">
         <div class="inner">
           <h2 class="top_aboutus_tit"><span class="fontDIN">We Work with World Premium Brands</span>本当に良いものだけを世界から</h2>
         ...
         <div class="inner">
           <ul class="top_pst_list op">
             <li class="wow fadeIn" data-wow-delay="0.2s">
              <a href="#">
                 <p class="top_pst_tit fontDIN hlg01">Premium Machines</p>
